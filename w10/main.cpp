...
int main() {
  Car C[8] = {Car("GVFGHI", "Tesla Model S"), Car("ABCDEF", "BMW 320"),
              Car("CDEFGH", "Ford Festiva"),  Car("BCDEFG", "Ford Festiva"),
              Car("GVDGHI", "Tesla Model 3"), Car("EFGHIJ", "Nissan Maxima"),
              Car("GVDEFG", "Tesla Model X")};
  Student S[6] = {Student(23456, "Lisa Simpson", 4.0),
  ...
  Employee E[6] = {Employee(213456, "Carl Carlson", 62344.56, 111),
  ...
  if (search(Cres, C, 8, "Tesla")) {
    cout << Cres.size() << " match" << (Cres.size() == 1 ? "" : "es")
         << " found:" << endl;
  ...
  // Call the  listArrayElements to list all the students, Title: "All
  // students:"
  ...
  if (search(Sres, S, 6, 4.0)) {
    cout << Sres.size() << " match" << (Sres.size() == 1 ? "" : "es")
         << " found:" << endl;
  ...
  // Call the  listArrayElements to list all the employees, Title: "All
  // employees:"
  ...
  if (search(Eres, E, 6, 111)) {
    cout << Eres.size() << " match" << (Eres.size() == 1 ? "" : "es")
         << " found:" << endl;
